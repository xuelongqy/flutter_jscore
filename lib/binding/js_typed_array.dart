...
final Pointer<Pointer> Function(Pointer ctx, Pointer object, Pointer<Pointer> exception)
    jSObjectGetTypedArrayBytesPtr = jscLib
        .lookup<NativeFunction<Pointer<Pointer> Function(Pointer, Pointer, Pointer)>>(
